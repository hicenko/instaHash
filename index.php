...
<head>
	...
	<title>InstaTag - так где правильные Hashteg'и </title>
	<link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
	<meta name="description" content="InstaTag - так где правильные Hashteg'и" />
	<meta name="keywords" content="instagram, hashtag, instahash" />
	<meta name="author" content="wDev"/>
...
<?php
	...
	require_once("func/addHash.php");
	require_once("func/addCategory.php");
?>
	<!-- Preloader -->
				...
				<div class="nav-header pull-left">
					<div class="logo-wrap">
						<a href="index.html">
							...
							<span class="brand-text">InstaHash</span>
						</a>
					</div>
				</div>	
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                       <div class="panel panel-default card-view panel-refresh">
							...
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">WorkoutCategory</h6>
								</div>
...
<!-- 									<div>
					...
					<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
						...
						<div class="panel panel-default card-view">
							<div class="panel-wrapper collapse in">
                                <div class="panel-body sm-data-box-1">
									<span class="uppercase-font weight-500 font-14 block text-center txt-dark">Add HashTag</span>
						...
						<div class="panel panel-default card-view">
							<div class="panel-heading">
								<div class="pull-left">
									<h6 class="panel-title txt-dark">Workout</h6>
								</div>
								<div class="pull-right">
...
<center><button class= "btn btn-success btn-anim" id="copyButton">Copy Cloud Hashtag</button></center>
<br>
								</div>	
							</div>
						</div>
